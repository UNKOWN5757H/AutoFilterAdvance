...
# ===================================================================
# 🚀 MONGODB PLUGIN SCANNER FIX
# ===================================================================
# Prevents Pyrogram's plugin scanner from throwing errors when it reads MongoDB objects
...
import pyromod  # Required for advanced bot features
...
class Bot(Client):
    def __init__(self):
        super().__init__(
            ...
            sleep_threshold=5,
            in_memory=True  # ⚡ THE SILVER BULLET: Bypasses the SQLite TypeError crash completely!
        )
...
if __name__ == "__main__":
    ...
    try:
        # Create loop securely for the services
