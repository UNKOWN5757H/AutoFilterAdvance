...
# ===================================================================
# 🧹 1. PURGE CORRUPTED SESSIONS BEFORE PYROGRAM BOOTS
# ===================================================================
# This prevents the 'TypeError' crash. Koyeb leaves corrupted session
# files behind on restart. We forcefully delete them before Bot() runs.
print("🔍 Clearing corrupted session files before boot...")
for file in glob.glob("*.session*"):
    try:
        os.remove(file)
        print(f"🗑️ Deleted session file: {file}")
    except Exception:
        pass

# ===================================================================
# ⚡ 2. CREATE EVENT LOOP (Critical for MongoDB)
# ===================================================================
try:
...
# ===================================================================
# 🚀 3. MONGODB CRASH FIX (Monkey Patch)
# ===================================================================
