...
async def get_search_results(
    ...
    try:
        ...
        if not conditions:
            # Absolute foolproof fallback regex
        ...
        # Safely wrap them without Umongo!
