...
async def set_autodelete_timer(bot: Client, message: Message):
    ...
    try:
        ...
        if seconds == 0:
            await message.reply_text("✅ **File Auto-Delete has been DISABLED (0 seconds).**")
        else:
            await message.reply_text(f"✅ **File Auto-Delete successfully set to:** `{seconds}` seconds.")
...
async def set_buttondel_timer(bot: Client, message: Message):
    ...
    try:
        ...
        if seconds == 0:
            await message.reply_text("✅ **Group Button Auto-Delete has been DISABLED (0 seconds).**")
        else:
            await message.reply_text(f"✅ **Group Button Auto-Delete successfully set to:** `{seconds}` seconds.")
