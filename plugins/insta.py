...
class InstaDownloader:
    ...
    def _download_video(shortcode, url, task_dir):
        ...
        return {"success": False, "error": "Server busy or Login Required (Ensure cookies.txt is valid)."}
...
# ============================================================
@Client.on_message((filters.command("insta") | filters.regex(r'(https?://)?(www\.)?instagram\.com/(p|reel|tv|stories)/([a-zA-Z0-9_\-]+)')) & filters.incoming)
