...
def get_start_buttons(user_id):
    ...
    buttons.append([InlineKeyboardButton("🔗 Nᴇᴡ Rᴇʟᴇᴀꜱᴇꜱ & Oᴛᴛ Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/sandalwood_kannada_moviesz", icon_custom_emoji_id=5258503720928288433, style=ButtonStyle.SUCCESS)])
...
async def start(client: Client, message: Message):
    ...
    try:
        msg = await client.send_cached_media(
            chat_id=message.from_user.id, file_id=db_file_id, caption=f_caption,
