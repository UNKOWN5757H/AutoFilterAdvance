...
def get_auto_delete_timer():
    try:
        val = getattr(info, "AUTO_DELETE", getattr(info, "FILE_AUTO_DELETE", 1800))
        return int(val)
    except (ValueError, TypeError):
        return 1800

async def silent_auto_delete(bot_message: Optional[Message], delay: int, warning_message: Optional[Message] = None):
...
async def start(client: Client, message: Message):
    ...
    # Handle standard string inputs in start
    ...
    # ⚡ ROUTE: DEEP-LINK FILE FETCHING ENGINE
...
# ============================================================
# 🧭 GLOBAL CALLBACK QUERY DISPATCHER (Fully Restored)
# ============================================================
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    try:
        ...
        # ⚡ ALL 20 TEXT SECTIONS FULLY MAPPED HERE
