...
# ============================================================
# ⚡ FIXED: DYNAMIC LINK GENERATION FOR CHANNELS PAGE
# ============================================================
async def get_channels_page(client: Client, page: int = 1):
    ...
    for i, chat in enumerate(current_chats, start=start_idx + 1):
        ...
        # ⚡ NEW: Dynamically fetch real invite link directly from Telegram!
        ...
        if username:
            ...
            try:
                ...
                if chat_obj.username:
                    ...
                    # Dynamically generate link if none exists
                    link = await client.export_chat_invite_link(chat_id)
            except Exception:
                # ⚡ Ultimate fallback if bot was kicked or lacks permissions
                clean_id = (
                    str(chat_id)[4:]
...
# ============================================================
# ⚡ FIXED: BULLETPROOF LEAVE CHANNEL SCRIPT
# ============================================================
@Client.on_message(
...
async def leave_channel_cmd(client: Client, message: Message):
    ...
    # Step 1: Attempt to leave physically
    try:
    ...
    # Step 2: Force scrub from DB even if Step 1 failed
    try:
