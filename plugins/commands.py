...
# ============================================================
# 🔘 INLINE BUTTON CALLBACK HANDLERS (Fixes non-working buttons)
# ============================================================
@Client.on_callback_query(filters.regex(r"^(help|about|close_data|start)$"))
async def main_callback_handler(client: Client, query: CallbackQuery):
    ...
    if data == "close_data":
        ...
        help_text = getattr(
            script,
            "HELP_TXT",
            "<b>ℹ️ Help Menu</b>\n\nUse this bot to find movies, receive file updates, and manage group settings.",
        )
